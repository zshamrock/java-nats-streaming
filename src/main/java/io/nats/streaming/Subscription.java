 ...
 * This means that if {@code StreamingConnection.subscribe("foo", cb)} is called twice in a row, each of the
...
public interface Subscription extends AutoCloseable {
     ...
     */
    void unsubscribe() throws IOException, InterruptedException, TimeoutException;
