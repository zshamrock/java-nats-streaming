...
#
echo Executing 'git clone --quiet --branch=gh-pages https://github.com/nats-io/java-nats-streaming.git gh-pages > /dev/null'
git clone --quiet --branch=gh-pages https://github.com/nats-io/java-nats-streaming.git gh-pages > /dev/null
...
git remote add pages ssh://git@github.com/nats-io/java-nats-streaming.git
